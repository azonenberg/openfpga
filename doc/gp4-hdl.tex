...
\hline
RESET\_MODE & String &  &
	{\bfseries RISING: } Resets the counter on a rising edge of RST. \newline
	{\bfseries FALLING: } Resets the counter on a falling edge of RST. \newline
	{\bfseries BOTH: } Resets the counter on any edge of RST. \newline
	{\bfseries LEVEL: } Resets the counter when RST is high. \\
\hline
\end{tabularx}
...
INPUT\_MODE & String & N/A &
	...
	{\bfseries SINGLE:} single-ended input \newline
	{\bfseries DIFF:} true differential input \newline
	{\bfseries PDIFF:} pseudo-differential input
\\
\hline
\end{tabularx}
...
\hline
PWRDN & Input & 1 &
	{\bfseries When PWRDN\_EN = 1:} \newline Bring this signal high to power down the oscillator. \newline
	{\bfseries When PWRDN\_EN = 0:} \newline Ignored, tie to 1'b0.\\
\hline
...
RESET\_MODE & String & 1 &
	{\bfseries RISING: } One-shot reset on rising edge of RST. \newline
	{\bfseries FALLING: } One-shot reset on falling edge of RST. \newline
	{\bfseries LEVEL: } System is held in reset while RST is high.\\
\hline
\end{tabularx}
