...
All clock sources other than on-chip oscillator. Pre-divider value of 12. Counters with input divider cannot be inferred 
from behavioral RTL, but can be instantiated as primitives.
...
\pagebreak
\clearpage
\subsection{\tokenstyle{GP\_PWRDET}: Power Detector (NOT IMPLEMENTED)}
\label{gp-pwrctl}
...
The example shown in figure \ref{gp-pwrdet-example} FIXME.
