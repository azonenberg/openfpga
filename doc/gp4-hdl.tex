...
\item Comparators: Buffered input on pin 6, global buffer bandwidth selection, speed doubler, 
...
If the PGA's output is used by other logic, it will remain on regardless of ADC power state.
