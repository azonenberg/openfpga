...
\pagebreak
\subsection{\tokenstyle{GP\_DELAY}: Prorgammable Digital Delay Line (NOT IMPLEMENTED)}
\label{gp-delay}
...
The \texttt{--top} argument is optional. If used, it must be immediately followed by the case-sensitive name of the top-level module. The default name if not specified is ``\tokenstyle{top}".
