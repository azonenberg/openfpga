...
\tokenstyle{OUT} & Output & 1 &
	\whenstyle{When 1:} when \tokenstyle{VIN} $>$ \tokenstyle{VREF} and comparator is running \newline
	\whenstyle{When 0:} when \tokenstyle{VIN} $<$ \tokenstyle{VREF} or comparator is powered down \\
\thinhline
