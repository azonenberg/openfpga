...
\item SPI: ADC buffer mode, parallel output to fabric.
\end{itemize}
...
\whenstyle{When 0:} active clock edge is centered in data eye \newline
\whenstyle{When 1:} data changes on active clock edge   \\
\thinhline
